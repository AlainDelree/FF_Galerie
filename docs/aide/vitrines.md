# Les vitrines et leurs scénarios

Une **vitrine** est un meuble d'exposition posé au sol dans une salle de sculptures. Elle regroupe plusieurs œuvres (sous forme de photos) et sert de **porte d'entrée** : le visiteur clique sur la vitrine, puis sur une œuvre, pour découvrir cette œuvre en grand. Vous décidez de tout ce parcours grâce aux **scénarios**.

## Bois ou verre

Chaque vitrine a un style, réglé dans l'onglet **Galerie** quand vous éditez la vitrine :

- **Bois** : le meuble est opaque. Portes fermées, on ne voit pas ce qu'il contient — c'est l'effet « coffre mystère ». Portes ouvertes, les œuvres apparaissent.
- **Verre** : on devine les œuvres à travers les portes, même fermées.
...
Un bouton **« Appliquer aux autres salles »** recopie le scénario choisi vers toutes vos autres salles de sculptures. Pratique pour garder une expérience homogène dans toute la galerie.

## Bon à savoir

- Un scénario ne concerne que les **œuvres présentées en vitrine**. Les sculptures posées directement au sol gardent leur comportement habituel.
- Quand une salle a un scénario, c'est lui qui commande l'ouverture des portes de ses vitrines. Le réglage manuel « Portes » de la vitrine est alors grisé, c'est normal.
- Comme toute modification, comptez **environ une minute** avant de voir le résultat sur le site public.
